...
with st.sidebar:
    ...
    st.markdown('<p class="custom-text">Mask  <span>Detecter</span> App</p>', unsafe_allow_html=True)
...
<section class="hero-section">
    <div class="container">
        <h1 class="hero-heading">Face Mask Detection Made Simple</h1>
        <p class="hero-text">
